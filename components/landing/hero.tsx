    ...
    <section className="relative overflow-hidden py-24 md:py-32">
      <div className="container mx-auto px-4">
        <div className="mx-auto max-w-4xl text-center">
          <div className="mb-6 inline-flex items-center gap-2 rounded-full border border-white/40 bg-white/20 px-4 py-1.5 text-sm">
            <WhatsAppIcon className="h-4 w-4 text-[#25D366]" />
            <span className="text-white/90">Integrimi i plotë me WhatsApp</span>
          </div>
          ...
          <p className="mx-auto mt-6 max-w-2xl text-pretty text-lg text-white/90 md:text-xl">
